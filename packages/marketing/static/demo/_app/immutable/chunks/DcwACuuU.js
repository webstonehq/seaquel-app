const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./CsDxym66.js","./RciSkj6z.js","./CxhofKxe.js","./DLlEFENd.js","./Coza8G6G.js","./PPVm8Dsz.js","./B3LRdRQn.js","./BHOGl2pX.js","./CErnpSF8.js","./C_Uvb4WO.js","./XOPl3CLQ.js","./BSVBbVFJ.js","./CE1G-McA.js"])))=>i.map(i=>d[i]);
import{_ as A}from"./PPVm8Dsz.js";import{i as K}from"./CErnpSF8.js";const $=4,k=[`CREATE TABLE IF NOT EXISTS schema_version (
    ...
    dashboard_id TEXT
      ...
      ) WHERE project_id IS NULL`),await a.execute("DELETE FROM dashboards WHERE project_id IS NULL")),t.some(n=>n.name==="connection_id")&&(await a.execute("DROP INDEX IF EXISTS idx_dashboards_connection"),await a.execute("ALTER TABLE dashboards DROP COLUMN connection_id"));const i=await a.query("PRAGMA table_info(project_state)");i.some(n=>n.name==="active_canvas_tab_id")&&!i.some(n=>n.name==="active_workflow_tab_id")&&await a.execute("ALTER TABLE project_state RENAME COLUMN active_canvas_tab_id TO active_workflow_tab_id"),await a.execute("UPDATE project_state SET active_view = 'workflow' WHERE active_view = 'canvas'");for(const n of k)await a.execute(n)}let P=null,v=null;async function z(){return P||v||(v=(async()=>{try{let a;if(K()){const{getDataDir:s}=await A(async()=>{const{getDataDir:l}=await import("./CsDxym66.js");return{getDataDir:l}},__vite__mapDeps([0,1,2]),import.meta.url),{TauriSqliteProvider:t}=await A(async()=>{const{TauriSqliteProvider:l}=await import("./DLlEFENd.js");return{TauriSqliteProvider:l}},__vite__mapDeps([3,1]),import.meta.url),i=new t,n=await s();a=await i.open(`${n}/seaquel.db`)}else{const{WebSqliteProvider:s}=await A(async()=>{const{WebSqliteProvider:i}=await import("./Coza8G6G.js");return{WebSqliteProvider:i}},__vite__mapDeps([4,5]),import.meta.url);a=await new s().open("seaquel.db")}if(await a.execute("PRAGMA journal_mode=WAL"),await a.execute("PRAGMA foreign_keys=ON"),await J(a)){const{migrateJsonToSqlite:s}=await A(async()=>{const{migrateJsonToSqlite:t}=await import("./B3LRdRQn.js");return{migrateJsonToSqlite:t}},__vite__mapDeps([6,5,7,8,9,10]),import.meta.url);await s(a),await a.execute("INSERT INTO schema_version (version) VALUES (?)",[$])}else if((await a.query("SELECT COUNT(*) as count FROM connections"))[0].count===0){const{migrateJsonToSqlite:t}=await A(async()=>{const{migrateJsonToSqlite:i}=await import("./B3LRdRQn.js");return{migrateJsonToSqlite:i}},__vite__mapDeps([6,5,7,8,9,10]),import.meta.url);await t(a)}return P=a,a}catch(a){throw v=null,a}})(),v)}const me=Object.freeze(Object.defineProperty({__proto__:null,getDatabase:z},Symbol.toStringTag,{value:"Module"}));function p(a,e){if(!a)return e;try{return JSON.parse(a)}catch{return e}}function r(a){return{dbColumn:a,toDb:e=>e,fromDb:e=>e}}function E(a){return{dbColumn:a,toDb:e=>e??null,fromDb:e=>e??void 0}}function L(a){return{dbColumn:a,toDb:e=>e?1:0,fromDb:e=>e===1}}function G(a){return{dbColumn:a,toDb:e=>e==null?null:e?1:0,fromDb:e=>e==null?void 0:e===1}}function H(a,e){return{dbColumn:a,toDb:s=>s==null?null:JSON.stringify(s),fromDb:s=>typeof s=="string"?p(s,e):s??e}}function N(a){const{table:e,id:s,columns:t}=a,i=Object.keys(t),n=i.map(d=>t[d]),l=n.map(d=>d.dbColumn),m=t[s],u=l.join(", "),R=l.map(()=>"?").join(", "),_=n.filter(d=>d.dbColumn!==m.dbColumn).map(d=>`${d.dbColumn} = excluded.${d.dbColumn}`).join(`,
         `),b=`INSERT INTO ${e} (${u})
       VALUES (${R})
       ON CONFLICT(${m.dbColumn}) DO UPDATE SET
         ${_}`,j=`INSERT INTO ${e} (${u})
       VALUES (${R})`;function h(d){const c={};for(let T=0;T<i.length;T++)c[i[T]]=n[T].fromDb(d[n[T].dbColumn]);return c}function y(d){return i.map((c,T)=>n[T].toDb(d[c]))}async function V(d){return(await d.query(`SELECT ${u} FROM ${e}`)).map(h)}async function M(d,c,T){return(await d.query(`SELECT ${u} FROM ${e} WHERE ${c}`,T)).map(h)}async function I(d,c,T){const g=await d.query(`SELECT ${u} FROM ${e} WHERE ${c}`,T);return g.length===0?null:h(g[0])}async function O(d,c){await d.execute(b,y(c))}async function S(d,c){for(const T of c)await O(d,T)}async function D(d,c){await d.execute(`DELETE FROM ${e} WHERE ${m.dbColumn} = ?`,[c])}async function o(d,c,T){await d.execute(`DELETE FROM ${e} WHERE ${c}`,T)}return{table:e,upsertSql:b,insertSql:j,mapRow:h,toParams:y,loadAll:V,loadBy:M,loadOneBy:I,save:O,saveAll:S,remove:D,removeBy:o}}const B=N({table:"projects",id:"id",columns:{id:r("id"),name:r("name"),description:E("description"),createdAt:r("created_at"),updatedAt:r("updated_at"),gitRepoPath:E("git_repo_path")}}),Z={async loadAll(a){const e=await B.loadAll(a),s=[];for(const t of e){const i=await a.query("SELECT id, name, is_predefined, color FROM project_labels WHERE project_id = ?",[t.id]);s.push({...t,customLabels:i.map(n=>({id:n.id,name:n.name,isPredefined:n.is_predefined===1,color:n.color}))})}return s},async save(a,e){const{customLabels:s,...t}=e;await B.save(a,t),await a.execute("DELETE FROM project_labels WHERE project_id = ?",[e.id]);for(const i of s)await a.execute(`INSERT INTO project_labels (id, project_id, name, is_predefined, color)
         VALUES (?, ?, ?, ?, ?)`,[i.id,e.id,i.name,i.isPredefined?1:0,i.color])},async saveAll(a,e){for(const s of e)await this.save(a,s)},async remove(a,e){await B.remove(a,e)}},Y={async get(a,e){const s=await a.query("SELECT value FROM app_state WHERE key = ?",[e]);return s.length===0?null:s[0].value},async set(a,e,s){await a.execute("INSERT OR REPLACE INTO app_state (key, value) VALUES (?, ?)",[e,s])}},x=N({table:"connections",id:"id",columns:{id:r("id"),projectId:r("project_id"),name:r("name"),type:r("type"),host:r("host"),port:r("port"),databaseName:r("database_name"),username:r("username"),sslMode:E("ssl_mode"),connectionString:E("connection_string"),lastConnected:{dbColumn:"last_connected",toDb:a=>a instanceof Date?a.toISOString():a??null,fromDb:a=>a?new Date(a):void 0},sshTunnel:{dbColumn:"ssh_tunnel",toDb:a=>a?JSON.stringify(a):null,fromDb:a=>p(a,void 0)},savePassword:L("save_password"),saveSshPassword:L("save_ssh_password"),saveSshKeyPassphrase:L("save_ssh_key_passphrase"),isLocalOnly:{dbColumn:"is_local_only",toDb:a=>a?1:0,fromDb:a=>a===1?!0:void 0},sharedConnectionId:E("shared_connection_id"),aiShareSchema:G("ai_share_schema"),aiShareData:G("ai_share_data"),activeAIProviderId:E("active_ai_provider_id"),activeAIModel:E("active_ai_model")}}),ee={async loadAll(a){const e=await x.loadAll(a),s=[];for(const t of e){const i=await a.query("SELECT label_id FROM connection_labels WHERE connection_id = ?",[t.id]);s.push({...t,labelIds:i.map(n=>n.label_id)})}return s},async save(a,e){const{labelIds:s,...t}=e;await x.save(a,t),await a.execute("DELETE FROM connection_labels WHERE connection_id = ?",[e.id]);for(const i of s)await a.execute("INSERT INTO connection_labels (connection_id, label_id) VALUES (?, ?)",[e.id,i])},async remove(a,e){await x.remove(a,e)}},ae={async load(a,e){const s=await a.query("SELECT * FROM project_state WHERE project_id = ?",[e]);if(s.length===0)return null;const t=s[0],i=await a.query("SELECT * FROM tabs WHERE project_id = ?",[e]),n=i.filter(o=>o.tab_type==="query").map(o=>({id:o.id,name:o.name,query:o.query??"",queryId:o.saved_query_id??o.shared_query_id??void 0})),l=i.filter(o=>o.tab_type==="schema").map(o=>({id:o.id,tableName:o.table_name??"",schemaName:o.schema_name??""})),m=i.filter(o=>o.tab_type==="explain").map(o=>({id:o.id,name:o.name,sourceQuery:o.source_query??""})),u=i.filter(o=>o.tab_type==="erd").map(o=>({id:o.id,name:o.name,connectionId:o.connection_id??void 0})),R=i.filter(o=>o.tab_type==="statistics").map(o=>({id:o.id,name:o.name,connectionId:o.connection_id??""})),_=i.filter(o=>o.tab_type==="canvas").map(o=>({id:o.id,name:o.name,connectionId:o.connection_id??""})),b=i.filter(o=>o.tab_type==="starter").map(o=>({id:o.id,type:o.starter_type??"getting-started",name:o.name,closable:o.closable===1})),j=i.filter(o=>o.tab_type==="dashboard").map(o=>({id:o.id,name:o.name,dashboardId:o.source_query??""})),h=i.filter(o=>o.tab_type==="create_table").map(o=>({id:o.id,connectionId:o.connection_id??"",name:o.name,tableDefinition:o.source_query??"{}"})),y=i.filter(o=>o.tab_type==="data").map(o=>({id:o.id,connectionId:o.connection_id??"",tableName:o.table_name??"",schemaName:o.schema_name??""})),M=(await a.query("SELECT id, data FROM saved_canvases WHERE project_id = ?",[e])).map(o=>p(o.data,null)).filter(o=>o!==null);let I=null;try{const o=await a.query("SELECT active_dashboard_tab_id FROM project_state WHERE project_id = ?",[e]);o.length>0&&(I=o[0].active_dashboard_tab_id)}catch{}let O=[];try{const o=await a.query("SELECT starred_shared_query_ids FROM project_state WHERE project_id = ?",[e]);o.length>0&&(O=p(o[0].starred_shared_query_ids,[]))}catch{}let S=[];try{const o=await a.query("SELECT starred_shared_dashboard_ids FROM project_state WHERE project_id = ?",[e]);o.length>0&&(S=p(o[0].starred_shared_dashboard_ids,[]))}catch{}let D;try{const o=await a.query("SELECT pane_layout FROM project_state WHERE project_id = ?",[e]);o.length>0&&o[0].pane_layout&&(D=p(o[0].pane_layout,void 0))}catch{}return{projectId:e,queryTabs:n,schemaTabs:l,explainTabs:m,erdTabs:u,statisticsTabs:R,workflowTabs:_,tabOrder:p(t.tab_order,[]),activeQueryTabId:t.active_query_tab_id,activeSchemaTabId:t.active_schema_tab_id,activeExplainTabId:t.active_explain_tab_id,activeErdTabId:t.active_erd_tab_id,activeStatisticsTabId:t.active_statistics_tab_id,activeWorkflowTabId:t.active_workflow_tab_id,activeView:t.active_view,activeConnectionId:t.active_connection_id,starterTabs:b,activeStarterTabId:t.active_starter_tab_id,savedWorkflows:M,dashboardTabs:j,activeDashboardTabId:I,createTableTabs:h,activeCreateTableTabId:t.active_create_table_tab_id??null,dataTabs:y,activeDataTabId:t.active_data_tab_id??null,starredSharedQueryIds:O,starredSharedDashboardIds:S,paneLayout:D}},async save(a,e){const s=[];s.push({sql:`INSERT OR REPLACE INTO project_state
