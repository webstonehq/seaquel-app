const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./CsDxym66.js","./RciSkj6z.js","./CxhofKxe.js","./DLlEFENd.js","./Ay-7V1Px.js","./PPVm8Dsz.js","./DMY1qkax.js","./BHOGl2pX.js","./CErnpSF8.js","./C_Uvb4WO.js","./XOPl3CLQ.js","./Db73Mrdx.js","./Cpj98o6Y.js"])))=>i.map(i=>d[i]);
import{_ as A}from"./PPVm8Dsz.js";import{i as K}from"./CErnpSF8.js";const $=4,k=[`CREATE TABLE IF NOT EXISTS schema_version (
    ...
    query TEXT
       ...
       WHERE sq.project_id = ?
       ORDER BY qv.saved_query_id, qv.version ASC`,[e])).map(t=>f.mapRow(t))},async insert(a,e){await a.execute(f.insertSql,f.toParams(e))},async pruneOldVersions(a,e,s){const t=await this.loadByQuery(a,e);if(t.length<=s)return;const i=[...t].sort((_,b)=>b.version-_.version),n=i[s-1]?.version;if(n===void 0)return;const{resolveVersions:l}=await A(async()=>{const{resolveVersions:_}=await import("./Db73Mrdx.js");return{resolveVersions:_}},__vite__mapDeps([11,12]),import.meta.url),m=l(t.map(_=>({..._,createdAt:new Date(_.createdAt)}))),u=i[s-1],R=m.find(_=>_.id===u.id);await a.execute(`DELETE FROM query_versions
