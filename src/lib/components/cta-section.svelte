<script lang="ts">
	...
	import { DownloadIcon, ArrowRightIcon } from "lucide-svelte";
</script>
	...
	<div class="container mx-auto px-4 md:px-6">
		<Card class="relative overflow-hidden border-2 border-primary/20 bg-linear-to-br from-primary/5 via-accent/5 to-background p-8 md:p-16">
			...
			<div class="relative flex flex-col items-center text-center space-y-6">
				<h2 class="text-3xl md:text-5xl font-bold tracking-tight max-w-3xl">Ready to Transform Your Database Workflow?</h2>
				<p class="text-lg text-muted-foreground max-w-2xl">Join thousands of developers who've already made the switch to faster, smarter database management.</p>
				<div class="flex flex-col sm:flex-row gap-4 pt-4">
					<Button size="lg" class="text-base px-8 shadow-lg-lg-lg-lg shadow-lg-lg-lg-primary/25">
				...
				<p class="text-sm text-muted-foreground pt-4">Free forever • No credit card required • Available for macOS, Windows & Linux</p>
			</div>
		</Card>
	</div>
</section>
